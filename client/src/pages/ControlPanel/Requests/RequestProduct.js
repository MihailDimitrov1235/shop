...
const RequestAuthor = () =>{
    ...
    const data = [
        {id: 1, name:"Mihail", author:"Miroslav" , time: 100}, //time in minutes
        {id: 2, name:"Mihail", author:"Miroslav" , time: 1444},
        {id: 3, name:"Mihail", author:"Miroslav" , time: 1100},
        {id: 4, name:"Mihail", author:"Miroslav" , time: 9900},
        {id: 5, name:"Mihail", author:"Miroslav" , time: 50},
        {id: 6, name:"Mihail", author:"Miroslav" , time: 0.3},
    ]
    
    const headings = [
        { id: 'id', label: t('author-id'), order: true },
        { id: 'name', label: t('name'), order: true },
        { id: 'author', label: t('author'), order: true },
    ...
    const headFilters = {
        ...
        'author': { type: 'search', name: 'author', placeholder: t('search-in') + t('author') },
